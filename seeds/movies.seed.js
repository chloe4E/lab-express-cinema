...
const MONGO_URI =
  process.env.MONGODB_URI || "mongodb://localhost/cinemaIronhack";
...
Movies.create(movies)
  .then((createdMovies) => {
    console.log(`Created ${createdMovies.length} movies in the DB`);
    mongoose.disconnect(() => console.log(`Disconnected from DB`)); // or mongoose.connection.close()
  })
  .catch((err) => console.log(err));

// run this with node movies.seed.js
